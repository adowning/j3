...
Copy these 3 files `/plugins/users_permissions/config/jwt.json`, `/plugins/users_permissions/config/roles.json` and `/plugins/users_permissions/models/User.settings.json` **from your old project** and paste them in the corresponding ones in your new project. It is important to save these files.
