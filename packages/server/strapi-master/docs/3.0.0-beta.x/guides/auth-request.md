...
To show you many of the concepts on the [roles and permissions](../plugins/users_permissions.md#manage-roles-permissions) part, we will use many users and roles.

After that we will see the [authentication workflow](../plugins/users_permissions.md#authentication) to get a `JWT` and use it for an API request.
...
To login as a user your will have to follow the [login documentation](../plugins/users_permissions.md#login).
