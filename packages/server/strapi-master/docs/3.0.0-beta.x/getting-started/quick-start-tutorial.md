...
[2019-07-30T15:21:17.698Z] info File created: /Users/paulbocuse/Desktop/Projects/my-project/extensions/users_permissions/config/jwt.json
...
- Click on the _right dropdown_ with `Permission (users_permissions)` and change it to `Restaurant`.
