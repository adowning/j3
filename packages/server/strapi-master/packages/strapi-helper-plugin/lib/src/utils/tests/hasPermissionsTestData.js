const hasPermissionsTestData = {
  userPermissions: {
    user1: [
      ...
      // users_permissions
      {
        action: 'plugins::users_permissions.roles.create',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.roles.read',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.roles.update',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.roles.delete',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.email-templates.read',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.email-templates.update',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.providers.read',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.providers.update',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.advanced-settings.read',
        subject: null,
        fields: null,
        conditions: null,
      },
      {
        action: 'plugins::users_permissions.advanced-settings.update',
        subject: null,
        fields: null,
        conditions: null,
      },
