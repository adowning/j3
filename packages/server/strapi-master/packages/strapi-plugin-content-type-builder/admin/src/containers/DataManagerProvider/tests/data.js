const data = {
  ...
  contentTypes: {
    ...
    'plugins::users_permissions.role': {
      uid: 'plugins::users_permissions.role',
      ...
      schema: {
        ...
        attributes: {
          ...
          permissions: {
            nature: 'oneToMany',
            target: 'plugins::users_permissions.permission',
            plugin: 'users_permissions',
            dominant: false,
          ...
          users: {
            nature: 'oneToMany',
            target: 'plugins::users_permissions.user',
            plugin: 'users_permissions',
            dominant: false,
            targetAttribute: 'role',
            unique: false,
    ...
    'plugins::users_permissions.user': {
      uid: 'plugins::users_permissions.user',
      plugin: 'users_permissions',
      schema: {
        name: 'users',
        description: '',
        ...
        attributes: {
          ...
          role: {
            nature: 'manyToOne',
            target: 'plugins::users_permissions.role',
            plugin: 'users_permissions',
            dominant: false,
    ...
    'plugins::users_permissions.permission': {
      uid: 'plugins::users_permissions.permission',
      plugin: 'users_permissions',
      schema: {
        name: 'permission',
        description: '',
