...
const usersPermissionsActions = require('../users_permissions-actions');
...
module.exports = async () => {
  ...
  // when plugin_users_permissions_grant is not existed in db
...
<p>Thanks.</p>`,
  ...
  await strapi.plugins['users_permissions'].services.userspermissions.initialize();

  if (!_.get(strapi.plugins['users_permissions'], 'config.jwtSecret')) {
    const jwtSecret = uuid();
    _.set(strapi.plugins['users_permissions'], 'config.jwtSecret', jwtSecret);
