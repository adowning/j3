...
const CustomTextInput = ({
  ...
  const link = (
    <a
      href="https://strapi.io/documentation/v3.x/plugins/users_permissions.html#templating-emails"
      target="_blank"
      rel="noopener noreferrer"
    >
      <FormattedMessage id="users_permissions.PopUpForm.Email.link.documentation" />
    </a>
  );
