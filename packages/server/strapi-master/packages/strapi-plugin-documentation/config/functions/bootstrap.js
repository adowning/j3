...
module.exports = async () => {
  // Check if the plugin users_permissions is installed because the documentation needs it
  if (Object.keys(strapi.plugins).indexOf('users_permissions') === -1) {
    throw new Error(
      'In order to make the documentation plugin works the users_permissions one is required'
    );
  }
