...
const seedWarehouseBoardItems = (
  project: Project
): Promise<WarehouseBoardItem[]> => {
  const { users } = project;

  const warehouseboarditems = [
    createEntity(WarehouseBoardItem, {
      title: "The rules and guidlines of the heist",
      type: WarehouseBoardItemType.WAREHOUSE,
      status: WarehouseBoardItemStatus.INPROGRESS,
      priority: WarehouseBoardItemPriority.HIGH,
      listPosition: 1,
      description: `<h3>These rules <strong>MUST</strong> be followed :</h3><p><br></p><ul><li><strong>No Killing:</strong> We want to appear to be Just Like Robin Hood, we do not intend to hurt anyone</li><li><strong>No Names:</strong> Everyone is nicknamed after a city. do not share you real names with anyone even me</li><li><strong>No Personal Relationships:</strong> this is good for preventing attachments that might compromise the operation</li></ul><p><br></p><h3><u style="background-color: initial;">That's it!</u></h3><h2>💯💯</h2><p><br></p>`,
      estimate: 12,
      timeSpent: 11,
    ...
    createEntity(WarehouseBoardItem, {
      ...
      type: WarehouseBoardItemType.WAREHOUSE,
      status: WarehouseBoardItemStatus.INPROGRESS,
      priority: WarehouseBoardItemPriority.LOW,
      listPosition: 2,
      description: `<h1>⛏️⛏️ We are digging our way out of the bank <strong>⛏️⛏️</strong></h1><p><br></p><p>Moscow and Denver will take care of digging a tunnel into the safe they are the best in the business.</p>`,
      estimate: 8,
      timeSpent: 4,
    ...
    createEntity(WarehouseBoardItem, {
      ...
      type: WarehouseBoardItemType.WAREHOUSE,
      status: WarehouseBoardItemStatus.INPROGRESS,
      priority: WarehouseBoardItemPriority.HIGHEST,
      listPosition: 4,
      description: `<h3>The Bastards almost killed me 😠😠</h3><p><br></p><p>Arturo tried escaping with the help of his secretary Mónica Gaztambide</p>`,
      estimate: 10,
      timeSpent: 2,
    ...
    createEntity(WarehouseBoardItem, {
      title: "Try leaving a comment on this warehouseboarditem.",
      type: WarehouseBoardItemType.WAREHOUSE,
      status: WarehouseBoardItemStatus.INPROGRESS,
      priority: WarehouseBoardItemPriority.MEDIUM,
      listPosition: 7,
      description: `<p>Adding comments to an warehouseboarditem is a useful way to record additional detail about an warehouseboarditem, and collaborate with team members. Comments are shown in the&nbsp;<strong>Comments</strong>&nbsp;section when you&nbsp;<a href="https://confluence.atlassian.com/jira064/what-is-an-warehouseboarditem-720416138.html" rel="noopener noreferrer" target="_blank" style="background-color: rgb(255, 255, 255); color: rgb(0, 82, 204);">view an warehouseboarditem</a>.</p><p><br></p><ol><li>Open the&nbsp;<a href="https://confluence.atlassian.com/jira064/what-is-an-warehouseboarditem-720416138.html" rel="noopener noreferrer" target="_blank" style="color: rgb(0, 82, 204);">warehouseboarditem</a>&nbsp;on which to add your comment.</li><li>Click the&nbsp;<strong>Add a comment</strong>&nbsp;button.</li><li>In the&nbsp;<strong>Comment</strong>&nbsp;text box, type your comment</li><li>Click the&nbsp;<strong>Save </strong>button or the <strong>Enter </strong>key to save the comment.</li></ol><p><br></p>`,
      estimate: 10,
      timeSpent: 2,
      reporterId: users[0].id,
      project,
    ...
    createEntity(WarehouseBoardItem, {
      title:
        "Each warehouseboarditem has a single reporter but can have multiple assignees.",
      type: WarehouseBoardItemType.WAREHOUSE,
      status: WarehouseBoardItemStatus.INPROGRESS,
      priority: WarehouseBoardItemPriority.HIGH,
      listPosition: 6,
      description: `<h2>Try assigning <u style="background-color: #ff7979;">Denver</u> to this warehouseboarditem. <span style="color: rgb(51, 51, 51);">🤣&nbsp;🤣&nbsp;🤣</span></h2><p><br></p>`,
      estimate: 6,
      timeSpent: 3,
      reporterId: users[1].id,
      project,
  ...
  return Promise.all(warehouseboarditems);
};
const seedComments = (
  issues: Issue[],
  ...
  const comments = [
    createEntity(Comment, {
      ...
      issueId: issues[1].id,
      warehouseBoardItemId: warehouseboarditems[1].id,
      userId: users[3].id,
    }),
    createEntity(Comment, {
      body:
...
const createGuestAccount = async (): Promise<User> => {
  ...
  const warehouseboarditems = await seedWarehouseBoardItems(project);
  await seedComments(issues, warehouseboarditems, project.users);
  return users[2];
};
